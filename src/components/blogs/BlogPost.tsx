      ...
      <div className="flex-1 min-w-0 lg:max-w-[60%]">
        <div className="flex flex-col text-white">
          <Link href={`/blogs/${slug}`} className="group">
            <h2 className="text-3xl font-medium md:text-4xl  transition-colors">
              {title}
            </h2>
          </Link>
          ...
          <Link
            href={`/blogs/${slug}`}
            className="mt-6 text-lg font-medium text-white hover:text-white/80 transition-colors inline-flex items-center"
          > 
