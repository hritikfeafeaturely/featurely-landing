  ...
  return (
    <article className="mt-9">
      <img
        ...
        className="aspect-[1.37] object-contain w-[925px] max-w-full"
      />

      <section className="mt-9">
        <h2 className="text-white text-[32px] font-semibold self-center ml-[83px] max-md:max-w-full">
      ...
      <section className="mt-[72px]">
        <h2 className="text-white text-[32px] font-semibold self-center ml-7 max-md:max-w-full">
      ...
      {/* Implementation continues with all sections from the design */}
      <section className="mt-9">
        <h2 className="text-white text-[32px] font-semibold max-md:max-w-full">
      ...
      <section className="mt-[72px]">
        ...
        <div className="text-white text-lg font-semibold leading-[26px] w-[925px] mt-9 max-md:max-w-full">
          1. Reducing Costly Iterations
          <br />
          ...
          <br />
          <br />
          2. Identifying UX Bottlenecks Early
          <br />
          <span className="font-normal">
          ...
          <br />
          <br />
          4. Enhancing Product-Market Fit (PMF)
          <br />
          <span className="font-normal">
      ...
      <section className="mt-[72px]">
        <h2 className="text-white text-[32px] font-semibold self-center ml-[72px] max-md:max-w-full">
      ...
      <section className="mt-[72px]">
        ...
        <div className="text-white text-lg font-normal leading-[26px] w-[925px] mt-9 max-md:max-w-full">
          ...
          modeling, product teams can: <br />
          <br />✅ Launch the right features faster
          <br />✅ Reduce iteration costs
          <br />✅ Improve UX before development begins
